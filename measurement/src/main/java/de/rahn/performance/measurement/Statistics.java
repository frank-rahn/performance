...
public class Statistics {
  ...
  /**
   * Datenklasse, um Zwischenwerte des Mittelwertes speichern zu können.
   *
   * @author Frank W. Rahn
   */
  ...
  private final String meteringPointName;
  ...
  /**
   * Speichere den aktuellen Mittelwert, wenn notwendig.
   */
